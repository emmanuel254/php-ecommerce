...
if ($cart_id != '') {
	...
	$cart_expire = date("Y-m-d H:i:s",strtotime("+30 days"));
	$db->query("INSERT INTO cart(items,expiry_date) VALUES ('{$items_json}','{$cart_expire}')") or die(mysqli_error($db));
	//$db->query("INSERT INTO `cart`(`items`, `expiry_date`, `paid`) VALUES ('$items_json','$cart_expire','0')") or die(mysqli_error($db));
